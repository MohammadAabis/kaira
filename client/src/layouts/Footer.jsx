          ...
          <div className="flex space-x-2 mt-3">
            ...
            <a href="#">
              <svg
                ...
                className="lucide lucide-twitter-icon lucide-twitter text-gray-500"
              >
            ...
            <a href="#">
              <svg
                ...
                stroke-linecap="round"
                stroke-linejoin="round"
                className="lucide lucide-youtube-icon lucide-youtube text-gray-500"
              >
            ...
            <a href="#">
              <svg
                ...
                stroke-linecap="round"
                stroke-linejoin="round"
                className="lucide lucide-instagram-icon lucide-instagram text-gray-500"
              >
